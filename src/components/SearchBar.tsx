...
const SearchBar = () => {
  ...
  const handleSubmit=(e:FormEvent)=>{
    e.preventDefault()
    // url'deki parametreleri güncelle
  ...
  return (
    <form onSubmit={handleSubmit} className="searchbar gap-3">
      <div className="searchbar__item">
        ...
        defaultValue={{label:params.get("make") as string,value:params.get("make") as string}}
        />
      ...
      <div className="searchbar__item">
        ...
        <input className="searchbar__input rounded text-black" placeholder="örn:Civic" type="text" onChange={(e)=>setModel(e.target.value)} defaultValue={params.get("model") as string} value={model} />
